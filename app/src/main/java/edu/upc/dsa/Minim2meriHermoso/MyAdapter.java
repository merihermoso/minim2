...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    private List<ReposResponse> values;
    ...
    public void add(int position, ReposResponse item) {
    ...
    public MyAdapter(List<ReposResponse> myDataset) {
        values = myDataset;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
       ...
       // Picasso.get().load(values.get(position).getAvatar_url()).into(holder.icon);
    }
